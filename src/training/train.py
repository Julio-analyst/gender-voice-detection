...
class ModelTrainer:
    ...
    def _setup_mlflow(self, experiment_name: Optional[str] = None):
        ...
        # Set experiment
        exp_name = experiment_name or os.getenv('MLFLOW_EXPERIMENT_NAME',
                                               self.config.get('mlflow.experiment_name', 
    ...
    def prepare_data(self, X: np.ndarray, y: np.ndarray, 
                    ...
                    random_seed: int = None) -> Dict[str, Tuple[np.ndarray, np.ndarray]]:
        """
    ...
    def train(self, 
        ...
        learning_rate = learning_rate or self.config.get('training.learning_rate', 0.001)
        hidden_units = hidden_units or self.config.get(f'models.{self.model_type}.hidden_units', 64)
