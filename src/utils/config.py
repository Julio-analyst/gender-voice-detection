...
class Config:
    ...
    def _load_env_overrides(self):
        ...
        if mlflow_uri:
            ...
            self.config['mlflow']['username'] = os.getenv("MLFLOW_TRACKING_USERNAME", "")
            self.config['mlflow']['password'] = os.getenv("MLFLOW_TRACKING_PASSWORD", "")
        ...
        self.config['training']['default']['batch_size'] = int(
            os.getenv("DEFAULT_BATCH_SIZE", self.config['training']['default']['batch_size'])
        )
        self.config['training']['default']['learning_rate'] = float(
            os.getenv("DEFAULT_LEARNING_RATE", self.config['training']['default']['learning_rate'])
        )
