...
class MFCCExtractor:
    ...
    def extract(
        self, audio: Union[np.ndarray, str, Path], sr: int = None
    ) -> np.ndarray:
        """
    ...
    def extract_from_file(
        self, audio_path: Union[str, Path], preprocess: bool = True
    ) -> np.ndarray:
        """
    ...
    def extract_batch(
        self, audio_files: List[Union[str, Path]], preprocess: bool = True
