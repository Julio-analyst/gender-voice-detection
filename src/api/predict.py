...
# Add CORS middleware
cors_origins = os.getenv('CORS_ORIGINS', '["http://localhost:7860", "http://localhost:3000"]')
...
def load_model(model_type: str = "lstm") -> keras.Model:
    ...
    # Get model path
    model_path = os.getenv(f'MODEL_{model_type.upper()}_PATH', 
                          f'models/{model_type}_production.h5')
